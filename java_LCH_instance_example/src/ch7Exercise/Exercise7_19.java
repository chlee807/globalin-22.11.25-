...
class Buyer {
	...
	void add(Product p) {
		 ...
		 * 바꾼다. 1.2 물건을 장바구니(cart) 에 저장한다 그리고 i의 값을 1증가시킨다
		 */
		if (i >= cart.length) {
...
/*
 * [ ] 실행결과 잔액이 부족하여 Computer을/를 살 수 없습니다. 구입한 물건:Tv, Computer, Tv, Audio,
 * Computer, Computer, 사용한 금액:850 남은 금액:150
 */
